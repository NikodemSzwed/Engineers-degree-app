...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'alerts', name: 'Alerts', component: Alerts, meta: { icon: 'pi pi-exclamation-triangle' } },
            { path: 'users', name: 'Users', component: Users, meta: { icon: 'pi pi-user', requiresAdmin: true } },
