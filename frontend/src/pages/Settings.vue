                ...
                <div class="flex flex-col justify-center gap-5">
                    <div class="flex flex-col items-center gap-5 lg:flex-row">
                        ...
                        <div class="flex w-full flex-row flex-wrap justify-center gap-3 lg:justify-start">
                            <div v-for="color in definedColor"
                                ...
                                @click="typeof color.color == 'string' ? changePrimaryColor(color.color) : changePrimaryColorToCustom(color.color)">
...
import { changePrimaryColor, changePrimaryColorToCustom, toggleDarkMode, saveTheme } from '../services/themeChanger';
