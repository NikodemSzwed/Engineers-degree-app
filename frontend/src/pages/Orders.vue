        ...
        <Dialog v-model:visible="addItemDialogVisible" header="Dodaj zlecenie" class="w-11/12 lg:w-1/2" modal>
            <Form :fields="addItemFields" @submit="addItemSave">
                ...
                <template #input-ParentEID="{ field }">
                    ...
                    <FormField
                        v-slot="{ id, name, value, onInput, invalid, errors }"
                        :name="field.name"
                    ...
                    >
                        <MapInterface
                            ...
                            :name="name"
                            :value="value"
                            @update:value="val => onInput({ target: { value: val } })"
                            ref="mapInterface"
                        />
...
<script setup>
    ...
    const columns = ref([
        ...
        {
            label: 'Nazwa sektora na którym się znajduje',
            field: 'ParentEIDName',
            type: 'text',
